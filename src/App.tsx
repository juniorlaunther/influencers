...
const EVENT_CONFIG = {
  ...
  duration: "A definir",
  supportUrl: "https://wa.me/5519981643970",
  refundPolicyUrl: "#"
};
...
const CheckoutButton = ({ className = "", children }: { className?: string, children: React.ReactNode }) => (
  <a 
    href={EVENT_CONFIG.checkoutUrl}
    target="_blank"
...
const SectionHeading = ({ children, className = "" }: { children: React.ReactNode, className?: string }) => (
  <motion.h2 
    ...
    className={`font-display text-4xl md:text-5xl lg:text-6xl tracking-tight text-shine ${className}`}
  >
    {children}
  </motion.h2>
);
...
const CountdownTimer = () => {
  ...
  if (isStarted) {
    return (
      ...
      >
         <div className="bg-gradient-to-r from-ig-magenta to-ig-orange text-white px-6 md:px-8 py-3 md:py-4 rounded-2xl font-display font-semibold text-lg md:text-xl shadow-[0_0_20px_rgba(225,48,108,0.3)] border border-white/20 text-center w-full sm:w-auto">
            A AULA COMEÇA AGORA
         </div>
      </motion.div>
    );
  ...
  const TimeUnit = ({ value, label }: { value: number, label: string }) => (
    <div className="flex flex-col items-center">
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl w-[4.5rem] h-[4.5rem] sm:w-20 sm:h-20 flex items-center justify-center shadow-lg">
        <span className="font-display font-medium text-3xl sm:text-4xl text-white">
          {value.toString().padStart(2, '0')}
        </span>
      </div>
      <span className="text-[0.65rem] sm:text-xs text-zinc-400 mt-2 uppercase tracking-widest">{label}</span>
    </div>
  );
  ...
  return (
    <motion.div 
      ...
      className="flex gap-3 sm:gap-4 justify-center lg:justify-start w-full pt-2 pb-2"
    >
...
export default function App() {
  return (
    <div className="min-h-screen bg-black font-sans selection:bg-ig-pink/30 selection:text-white relative z-0">
      ...
      {/* UPPER BAR */}
      <div className="w-full bg-gradient-to-r from-ig-purple via-ig-pink to-ig-orange text-white py-2 px-4 text-center z-50 relative">
      ...
      */}
          ...
          <div className="lg:w-[65%] flex flex-col items-center lg:items-start text-center lg:text-left w-full container-h">
            ...
            <div className="flex flex-col items-center lg:items-start space-y-6 lg:space-y-8 w-full">
              ...
              >
                ...
                <span className="text-sm font-medium tracking-wide text-zinc-300 uppercase">AULA AO VIVO</span>
              </motion.div>
              ...
              >
                <span className="block whitespace-nowrap text-[2.75rem] min-[390px]:text-[3.15rem] min-[420px]:text-[3.5rem] sm:text-5xl md:text-7xl lg:text-[4.5rem] xl:text-[5.5rem] text-gradient">O SEGREDO DOS</span>
                <span className="text-shine block text-[2.75rem] min-[390px]:text-[3.15rem] min-[420px]:text-[3.5rem] sm:text-5xl md:text-7xl lg:text-[4.5rem] xl:text-[5.5rem]">INFLUENCERS</span>
              </motion.h1>
            </div>
            ...
            <div className="flex flex-col items-center lg:items-start space-y-6 lg:space-y-8 w-full mt-2 lg:mt-8">
              ...
              >
                Descubra as estratégias por trás dos criadores que conquistam atenção, transformam conteúdo em comunidade e constroem oportunidades reais na internet.
              </motion.p>
              ...
              >
                <CheckoutButton className="bg-gradient-to-r from-ig-magenta to-ig-orange text-white w-full sm:w-auto text-[1.1rem] md:text-xl shadow-[0_0_40px_rgba(225,48,108,0.3)] !px-8 !py-4">
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="flex-1 w-[calc(100%+2rem)] -mx-4 md:w-full md:mx-0 relative">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6">
                 <div className="flex items-center gap-3 bg-black/40 backdrop-blur-md p-4 rounded-xl border border-white/10 w-max animate-error-shake">
          ...
          <div className="flex-1 space-y-10 text-center lg:text-left z-10">
            <SectionHeading className="!leading-tight">
              AFINAL, QUAL É O <br className="hidden md:block" /> 
              <span className="italic text-gradient font-light">SEGREDO DOS INFLUENCERS?</span>
            </SectionHeading>
            ...
            >
              <p>
                Não existe um botão secreto, uma fórmula universal ou uma garantia de viralização. O verdadeiro segredo está na combinação entre posicionamento, identidade, conteúdo, estratégia, consistência e capacidade de criar conexão com as pessoas.
              </p>
              <p className="text-zinc-200 font-medium">
                Nesta aula, Junior Launther vai revelar as decisões e estratégias que utiliza para transformar ideias em conteúdos, conteúdos em comunidade e presença digital em oportunidades profissionais.
              </p>
            </motion.div>
            ...
            >
              <CheckoutButton className="bg-white/5 hover:bg-white/10 text-white border border-white/10 text-[0.95rem] sm:text-[1.05rem] md:text-lg w-full sm:w-auto">
                QUERO DESCOBRIR O SEGREDO
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 relative z-10 w-full">
          <div className="flex-1 w-full space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            <div className="text-[1.1rem] md:text-lg text-zinc-400 font-light space-y-4 md:space-y-6 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              ...
              <p>
                Esta aula te dá estrutura: clareza do que postar e como manter a retenção. O resultado disso? Uma atração orgânica real, contínua e baseada em qualidade.
              </p>
            </div>
            ...
            >
              <CheckoutButton className="bg-white/10 hover:bg-white/20 text-white w-full sm:w-auto text-[0.95rem] sm:text-[1.05rem] md:text-lg border border-white/10 backdrop-blur-md">
                QUERO DESCOBRIR O SEGREDO
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="flex-1 lg:sticky lg:top-32 h-max">
            <div className="mb-8 md:mb-12">
              <span className="text-ig-orange font-medium tracking-wider uppercase text-sm mb-4 block">O que você vai aprender</span>
              <SectionHeading className="!text-4xl md:!text-5xl">O que você vai aprender</SectionHeading>
              <p className="text-[1.1rem] md:text-lg text-zinc-400 mt-4 md:mt-6 max-w-md font-light leading-relaxed">
                Você vai conhecer os principais elementos que existem por trás de um perfil que chama atenção, conquista seguidores e se torna interessante para pessoas e marcas.
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col pt-0 lg:pt-8">
            <FlowingDeliverable 
              ...
              desc="Como alinhar a sua identidade visual e mensagem para que qualquer pessoa entenda de cara quem você é e seu nível de profissionalismo."
              icon={Target}
              delay={0}
            ...
            />
            <FlowingDeliverable 
              title="Vídeos que prendem atenção"
              desc="Estratégias práticas para criar conteúdos magnéticos que retêm o público do início ao fim."
              icon={Camera}
              delay={0.1}
            ...
            />
            <FlowingDeliverable 
              title="Crescimento e Viralização"
              desc="Descubra como transformar o engajamento orgânico em uma máquina previsível de crescimento sustentável."
              icon={TrendingUp}
              delay={0.2}
            ...
            />
            <FlowingDeliverable 
              title="Marcas, Oportunidades e Plano de ação"
              desc="Como se apresentar para o mercado, monetizar sua audiência e sair com próximos passos práticos para aplicar imediatamente."
              icon={Briefcase}
              delay={0.3}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 relative z-10">
          ...
          <div className="flex-1 w-full space-y-8 md:space-y-10 text-center lg:text-left">
            ...
            >
              ...
              <p className="text-zinc-200 font-medium">
                A aula prepara o seu perfil para ser visto como um negócio. Vamos arrumar a casa, refinar sua vitrine e mostrar como se apresentar para que as marcas desejem associar o nome delas ao seu.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="pt-2 md:pt-4 flex justify-center lg:justify-start"
            >
              <CheckoutButton className="bg-gradient-to-r from-ig-purple to-ig-pink text-white w-full sm:w-auto text-[0.95rem] sm:text-[1.05rem] md:text-lg shadow-[0_0_40px_rgba(131,58,180,0.3)]">
                QUERO DESCOBRIR O SEGREDO
                <ArrowRight size={18} className="md:w-5 md:h-5" />
              </CheckoutButton>
            </motion.div>
          ...
          <div className="flex-1 w-full text-center md:text-left">
            ...
            >
              ...
              <p className="text-zinc-100 font-medium">
                Na aula O Segredo dos Influencers, ele une criatividade, vivência real de internet e análise sincera para ajudar criadores de conteúdo a enxergarem a criação de conteúdo como trabalho.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-stretch">
            <TestimonialItem 
              name="Caroline"
              handle="@carolineamad"
              text="Virou uma chave total! Mesmo com poucos seguidores, eu consegui melhorar meu conteúdo e tenho fechado muitas publis na minha cidade. Até FIXAS."
            ...
            <TestimonialItem 
              ...
              text="O Junior foi um grande parceiro desde quando eu tinha 40mil seguidores. Gosto de estar sempre atualizado e melhorando com as ideias dele!"
          ...
          >
            <CheckoutButton className="bg-white/5 hover:bg-white/10 text-white border border-white/10 w-full sm:w-auto text-[0.95rem] sm:text-[1.05rem] md:text-lg backdrop-blur-md">
              QUERO DESCOBRIR O SEGREDO
              <TrendingUp size={18} className="md:w-5 md:h-5" />
            </CheckoutButton>
          </motion.div>
      ...
      <section className="py-16 md:py-32 px-4 md:px-8 relative overflow-hidden bg-black">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-10 md:space-y-12">
          <motion.div
             ...
             transition={{ duration: 0.8 }}
          >
            <h2 className="font-display text-[2.5rem] leading-[1.1] sm:text-4xl md:text-5xl font-medium tracking-tighter mb-4 md:mb-6">
              <span className="text-shine">O SEGREDO NÃO É APENAS VIRALIZAR.</span> <br/>
            ...
            <CheckoutButton className="bg-white text-black hover:bg-zinc-200 w-full sm:w-auto text-[1.05rem] md:text-xl px-6 md:px-12 py-5 shadow-[0_0_50px_rgba(255,255,255,0.15)] flex-col sm:flex-row h-auto gap-2 sm:gap-3 rounded-[1.5rem] sm:rounded-full">
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 border-t border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-2">
            <FAQItem 
              question="Para quem é a aula ao vivo?"
              answer="A aula foi pensada exclusivamente para criadores de conteúdo e influenciadores pequenos (ou iniciantes) que sentem que têm potencial, mas ainda precisam de direção em estética, posicionamento e olhar comercial."
            />
            <FAQItem 
              question="A aula garante parcerias com marcas?"
              answer="Nenhum profissional sério pode garantir parcerias. O objetivo desta aula é organizar a 'casa' (seu perfil) e alinhar a sua postura, estética e comunicação para que, quando as marcas chegarem (ou você as abordar), o seu perfil reflita um criador 100% profissional e valorizado."
            />
            <FAQItem 
              question="Como funciona o ingresso?"
              answer="Ao clicar no botão, você garantirá seu ingresso de forma segura. Enviaremos o acesso da aula ao vivo (1 hora de duração) no dia do evento. O ingresso é uma maneira que encontramos de filtrar curiosos por pessoas que, realmente, estão dispostas a se tornar influencers de maneira profissional e estratégica. Caso sinta que a aula não entregou o que você imaginava, poderá solicitar o reembolso em até 7 dias."
            />
            <FAQItem 
              question="O que preciso ter pronto para a aula?"
              answer="Apenas o seu Instagram ativo e vontade de aprender. Vamos focar puramente em insights, feedback, direção e plano de ação que você pode aplicar imediatamente."
            />
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 px-4 text-center text-zinc-600 font-sans border-t border-white/5">
        ...
        <p className="text-sm max-w-sm mx-auto leading-relaxed">&copy; {new Date().getFullYear()} O Segredo dos Influencers. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
